...
kubectl port-forward -n monitoring svc/grafana-service 3000:3000 --address 0.0.0.0 > /dev/null 2>&1 &
```

or

``` bash
kubectl port-forward -n monitoring svc/prometheus-service 9090:9090 --address 0.0.0.0 > /dev/null 2>&1 &
```
...
Access: grafana and prometheus URL
...
## Sample grafana dashboards, which will help you

| ID    | Purpose               |
| ----- | --------------------- |
| 1860  | Node Exporter Full    |
| 3662  | Prometheus 2.0        |
| 17519 | kube-state-metrics    |
| 11670 | cAdvisor              |
| 15762 | CoreDNS               |
| 15761 | API Server            |
| 15757 | Kubernetes All-in-One |
...
-   This environment is for lab/testing --- not production workloads, but with some changes you can use in production.
